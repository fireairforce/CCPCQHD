...
export default class FocusSecondThree extends Component{   
   constructor(){
       super()
       this.state={
           mytext: '',    
   ...
   getData(){  
        ...
        method: 'GET'
            ...
            console.log(receive.data[3].title);      
          }
         )
    }
    componentDidMount(){
       ...
       return(
           <div className={styles.FocusContainer}>
                <div className={styles.FocusHeader}>
                    <img src={this.state.mytext.data ? this.state.mytext.data[3].previewImg : 'null'} alt="logo" style={{width:'1200px',height:'500px'}}/>
                </div>
                <div className={styles.FocusBody}>
                    <div className={styles.FocusBodyHeader} >
                       {this.state.mytext.data ? this.state.mytext.data[3].title : 'null'}
                    </div>
                    <div 
