...
class NewsSecondTwo extends Component{
    constructor(){
        super()
        this.state={
            mytext: '',    
        ...
        return(
            <div className={styles.SecondContainer}>
               ...
               <div className={styles.SecondHeader} >
                    <h1>{this.state.mytext.data ? this.state.mytext.data[2].title : 'null'}</h1>
               </div> 
               <div className={styles.SecondPic}>
                  <img src={this.state.mytext.data ? this.state.mytext.data[2].previewImg : 'null'} alt="NEUQ1" style={{width:'1200px',height:'500px'}}/>
               </div>
