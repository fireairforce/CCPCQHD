   ...
   getData(){  
        ...
        method: 'GET'
            ...
            this.setState({mytext:receive},() => {
                console.log('mytext', this.state.mytext.data[1])
                // m=this.state.mytext.data[0];
            }); 
            console.log(receive.data[1].title);      
          }
         )
    }
    componentDidMount(){
    ...
    render(){
        ...
        console.log(this.state.mytext.data ? this.state.mytext.data[1].previewImg : 'null');
       return(
           <div className={styles.FocusContainer}>
                <div className={styles.FocusHeader}>
                    <img src={this.state.mytext.data ? this.state.mytext.data[1].previewImg : 'null'} alt="logo" style={{width:'1200px',height:'500px'}}/>
                </div>
                <div className={styles.FocusBody}>
                    <div className={styles.FocusBodyHeader} >
                       {this.state.mytext.data ? this.state.mytext.data[1].title : 'null'}
                    </div>
                    <div 
